...
public class ReservationController {
    ...
    public ResponseEntity<ReservationResponseDTO> changeStatus(@PathVariable int reservation_id, @Valid @RequestBody ReservationStatusRequestDTO reservationStatusRequestDTO) {
